"""priority_d notifications

Revision ID: eaaa75531305
Revises: 243ce87d48ba
Create Date: 2025-08-26 06:01:08.659363
...
revision = 'eaaa75531305'
down_revision = '243ce87d48ba'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.Column('type', sa.Enum('予約確認', 'コメント', 'いいね', 'イベント', 'システム', name='notificationtype'), nullable=False),
