...
Revision ID: 8824301f4867
Revises: b758e7932be9
Create Date: 2025-08-26 05:05:36.262787
...
revision = '8824301f4867'
down_revision = 'b758e7932be9'
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    sa.Column('post_type', sa.Enum('お知らせ', '日記', '質問', 'その他', name='posttype'), nullable=True),
    ...
    op.create_index('ix_posts_is_public', 'posts', ['is_public'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_posts_is_public', table_name='posts')
