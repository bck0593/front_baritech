...
export function PhotoSlider({ className = '' }: PhotoSliderProps) {
  ...
  const slideTexts = [
    {
      title: "犬の保育園とは？",
      description: "日常的なデイケアと成長サポートを安心の環境で。"
    },
    {
      title: "アシックス里山スタジアム",
      description: "FC今治のホームスタジアム。365日人が集い、賑わう場所。"
    },
    {
      title: "里山サロンで休憩",
      description: "ドッグランで遊んだあとは、カフェ『里山サロン』でゆっくりと。"
    },
    {
      title: "共に楽しく過ごせる場所",
      description: "アシックス里山スタジアムで様々なイベントを実施しています。"
    }
  ]
